		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#manageagreement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"manageagreement-display": {
								"semanticObject": "manageagreement",
								"action": "display",
								"description": "A Manage-Agreement application.",
								"title": "Manage-Agreement",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=manageagreement",
									"url": sap.ui.require.toUrl("manageagreement")
								}
							}
						}
					}
